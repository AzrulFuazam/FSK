...
class IntroSliderMotorHalus extends StatefulWidget {
  @override
  _IntroSliderMotorHalusState createState() => _IntroSliderMotorHalusState();
}

class _IntroSliderMotorHalusState extends State<IntroSliderMotorHalus> {
