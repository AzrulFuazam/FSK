...
import 'package:fsk/domain/motorhalus/motorhalus.dart';
import 'package:fsk/domain/motorhalus/motorhalusquestion.dart';
...
List<String> WENTI = [
  'Menghisap puting susu dengan baik semasa menyusu atau diberi botol susu.',
  'Cuba untuk memegang botol susu mengunakan tangan.Nota: Sekiranya anak tidak menyusu dengan botol susu, letakkan “TB” di ruang “Tanda”.',
  'Membuka mulut apabila disuapkan makanan dengan sudu.',
  'Memegang botol susu menggunakan 2 tangan ketika menyusu.Nota: Sekiranya anak tidak menyusu dengan botol susu, letakkan “TB” di ruang “Tanda”.',
  'Memegang makanan menggunakan jari. ',
  'Memasukkan makanan ke dalam mulut menggunakan tangan.',
  'Makan makanan yang telah dilenyek/dikisar bertekstur pekat  (contoh: makanan bertekstur pekat seperti kentang lenyek (mesh potatoes), nasi lenyek)..',
  'Mula makan menggunakan sudu, mungkin terdapat tumpahan makanan dari sudu.',
  'Makan makanan lembut yang dipotong/dikisar halus.',
  'Minum dari botol air atau cawan muncung berpenutup untuk mengelakkan tumpahan dengan memegang menggunakan 2 tangan. ',
  'Minum air menggunakan penyedut minuman.',
  'Menyuap makanan dengan sendiri menggunakan sudu tanpa bantuan dengan sedikit tumpahan makanan. ',
  'Mengunyah dan makan makanan pepejal bersaiz ketulan kecil atau saiz satu suapan.',
  'Mengelap mulut selepas makan.',
  'Mengunyah dan makan makanan pepejal keras seperti potongan epal dan ketulan ayam yang kecil.',
  'Memegang pinggan semasa menyuap makanan sendiri.',
  'Mula makan menggunakan garpu, mungkin terdapat tumpahan makanan dari garpu.',
  'Boleh makan menggunakan sudu dengan baik, kurang tumpahan makanan.',
  'Boleh makan menggunakan garpu, kurang tumpahan makanan.',
  'Boleh menyuap diri sendiri menggunakan sudu dan garpu tanpa tumpahan makanan.',
  'Minum menggunakan cawan atau gelas biasa tanpa tumpahan.',
  'Menuang air sendiri dari bekas air kecil ke cawan.',
  'Memilih alat yang betul untuk mengambil makanan (contoh: menggunakan penyepit untuk mengambil kueh, menggunakan senduk untuk menyedok nasi).',
  'Boleh makan dan mengunyah semua jenis makanan pelbagai tekstur.',
  'Menyediakan makanan yang mudah seperti menuang susu dalam bijirin atau menyapu kaya/jam di roti.',
  'Menggunakan pisau meja untuk menyapu/meratakan jam/mentega di roti. ',
...
List<String> Respondstanda = List.filled(27, 'DEF');
...
Future main() async {
  runApp(IntroSliderMotorHalus());
}

class soalanmotorhalus extends StatefulWidget {
  _soalanmotorhalusState createState() => _soalanmotorhalusState();
}

@override
class _soalanmotorhalusState extends State<soalanmotorhalus>
